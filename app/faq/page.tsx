    ...
    const accordionData = [
        {
            ...
            answer: `გამოყენების სიმარტივე, ფუნქციონალის სიმდიდრე, ფუნქციონალთან მიმართებით დაბალი ფასი, განცხადებათა უიერარქიო სისტემა, თანამედროვე დიზაინი...`
        },
        {
        ...
        },
        {
            ...
            answer: "რეზიუმეს გაგზავნისთვის არაა საჭირო ანგარიშის შექმნა, უბრალოდ შედი განცხადების გვერდზე, ატვირთე შენი რეზიუმე (PDF ფორმატი), და დააჭირე გაგზავნას."
        },
        {
            question: "პრემიუმ განცხადებები არ გაქვთ?",
            answer: `Jobby.ge-ზე ყველა განცხადება თანასწორია. პრემიუმ განცხადებები და ზოგადად განცხადებათა იერარქიულობა ართულებს მომხმარებლის, განსაკუთრებით სამსახურისმაძიებლის გამოცდილებას. განცხადებათა დაფების უმრავლესობის მთავარი ნაკლი არის გადატვირთულობა, რაც აუარესებს მომხმარებლის გამოცდილებას.`
        },
        {

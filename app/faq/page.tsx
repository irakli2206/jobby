...
const FAQ = () => {
    const accordionData = [
        ...
        },
        {
            ...
            answer: `შექმენი ანგარიში, მართვის პანელში დააჭირე "ზღვრის გაზრდის" ღილაკს ან საიტის ზემო ნაწილში დააჭირე "ფასს", აირჩიე საყიდელი განცხადებების რაოდენობა და დააჭირე ყიდვას. ყიდვის შემდეგ მაშინვე შეგეძლება განათავსო ახალი განცხადებები.`
        },
        // {

...
const FAQ = () => {
    const accordionData = [
        ...
        {
            question: "როგორ შეედრება Jobby.ge-ის ფასი სხვა პლატფორმების ფასებს?",
            answer: `Jobby.ge-ის ერთერთი დადებითი მხარე არის ერთიანი გადახდა ყველა ფუნქციისთვის. 44 ლარად შენ ქმნი სრულფასოვან განცხადებას. არანაირი დამატებითი გადახდები ახალი ფუნქციონალის გასახსნელად და 50 სახის პრემიუმ სტატუსი თქვენ არ დაგჭირდებათ, და არც მოგიწევთ ღელვა იმაზე რომ ვიღაცის პრემიუმ განცხადება დაჩრდილავს თქვენსას! \n
                მაშ ასე, 
                Jobby.ge - 44 ლარი. 
                jobs.ge - სტანდარტული განცხადების და კომპანიის ლოგოს დასადებად 55 ლარი.
                hr.ge - საკმაოდ მოქნილი არჩევნის მქონე საიტი. სტანდარტი ღირს 40 ლარი, თუმცა ფუნქციონალში არ შედის განცხადების ნახვების დათვლა.
            `
        },
        {
        ...
        },
        {
            ...
            answer: `დადებული განცხადება თავისით წაიშლება 1 თვის გასვლის შემდეგ. თუ გინდა რომ შეზღუდო შენი განცხადების ხილვადობა, გადადი განცხადებების მართვის პანელში, დააჭირე სამწერტილს მარჯვენა მხარეს და აირჩიე "დამალვა"`
        },
        {
